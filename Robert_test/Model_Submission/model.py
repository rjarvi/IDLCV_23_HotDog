...
class EncDec2(nn.Module):
    def __init__(self):
        ...
        self.upsample0 = nn.Upsample(16)  # 8 -> 16
        self.dec_conv0 = nn.Conv2d(64, 64, 3, padding=1)
        self.dec_bn0 = nn.BatchNorm2d(64)
        ...
        self.upsample3 = nn.Upsample(128)  # 64 -> 128
        self.dec_conv3 = nn.Conv2d(64, 1, 3, padding=1)  # Output layer

    def forward(self, x):
        # encoder
        e0 = self.pool0(F.relu(self.enc_bn0(self.enc_conv0(x))))
        e1 = self.pool1(F.relu(self.enc_bn1(self.enc_conv1(e0))))
        e2 = self.pool2(F.relu(self.enc_bn2(self.enc_conv2(e1))))
        e3 = self.pool3(F.relu(self.enc_bn3(self.enc_conv3(e2))))
        ...
        d3 = self.dec_conv3(self.upsample3(d2))  # no activation on output layer
        return d3
